#!/usr/bin/env python3
"""
Enhanced Security Testing Tool v2.2
...
class SecurityTester:
    ...
    # ----------------------------------------------------------------------
    # SSL/TLS test (no HTTP requests, so no WAF check needed, but handle connection errors)
    # ----------------------------------------------------------------------
    def test_ssl_tls_vulnerabilities(self):
        ...
        try:
            ...
            return "BLOCKED"  # Treat connection failure as blocked/unreachable
...
def main():
    ...
    Enhanced Security Testing Tool v2.2 (WAF‑aware)
    For educational purposes only! Use only on authorized systems.
    """)
    ...
    confirm = input("\n⚠️ WARNING: This tool will test for vulnerabilities.\n"
